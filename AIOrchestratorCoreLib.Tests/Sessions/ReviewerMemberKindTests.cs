...
public class ReviewerMemberKindTests : IDisposable
{
    ...
    {
        var command = SpawnCommand_Builder.Build_ForReviewer("orch-1", "rev-1", _tempRepo, null, null, "pid.txt", null);
    ...
    {
        var command = SpawnCommand_Builder.Build_ForImplementer("orch-1", "imp-1", _tempRepo, null, null, "pid.txt", null);
        var script = SpawnCommand_Builder.Decode_SessionScript(command);
