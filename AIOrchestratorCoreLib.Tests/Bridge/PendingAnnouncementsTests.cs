...
public class PendingAnnouncementsTests
{
    ...
    public void AQueuedAnnouncementIsDeliveredOnALaterDrain()
    {
        ...
        queue.Queue("orch-1", CHANNEL, AppEntryAudiences.Owner, "the owner went away", "body", NOW);
    ...
    public void AFailureStopsThatChannelsDrain_SoNothingOvertakesWhatIsStuck()
    {
        ...
        queue.Queue("orch-1", CHANNEL, AppEntryAudiences.Owner, "first", "body", NOW);
        queue.Queue("orch-1", CHANNEL, AppEntryAudiences.Owner, "second", "body", NOW.AddSeconds(1));
        queue.Queue("orch-1", CHANNEL, AppEntryAudiences.Owner, "third", "body", NOW.AddSeconds(2));
    ...
    public void AfterTheLockClears_TheyArriveInTheOrderTheyWereQueued()
    {
        ...
        queue.Queue("orch-1", CHANNEL, AppEntryAudiences.Owner, "away ON", "body", NOW);
        queue.Queue("orch-1", CHANNEL, AppEntryAudiences.Owner, "away OFF", "body", NOW.AddSeconds(1));
    ...
    public void AWedgedChannelDoesNotHoldUpADifferentChannel()
    {
        ...
        queue.Queue("orch-1", CHANNEL, AppEntryAudiences.Owner, "stuck", "body", NOW);
        queue.Queue("orch-2", OTHER_CHANNEL, AppEntryAudiences.Owner, "fine", "body", NOW);
    ...
    public void ASecondAnnouncementArrivingWhileTheFirstIsStuck_ComesOutBehindIt()
    {
        ...
        queue.Queue("orch-1", CHANNEL, AppEntryAudiences.Owner, "the owner is back", "body", NOW.AddSeconds(3));
    ...
    public void PastTheCap_TheOldestIsDroppedAndReturnedSoItCanBeLogged()
    {
        ...
        for (var index = 0; index < IPendingAnnouncements.PER_CHANNEL_CAP; index++)
            Assert.Null(queue.Queue("orch-1", CHANNEL, AppEntryAudiences.Owner, $"announcement {index}", "body", NOW.AddSeconds(index)));

        var dropped = queue.Queue("orch-1", CHANNEL, AppEntryAudiences.Owner, "the newest", "body", NOW.AddMinutes(1));
