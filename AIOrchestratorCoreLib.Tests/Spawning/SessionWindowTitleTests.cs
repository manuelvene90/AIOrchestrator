...
public class SessionWindowTitleTests
{
    ...
    public void Implementer_TheWindowItSpawns_IsTheWindowTheTerminatorCloses()
    {
        ...
        var command = SpawnCommand_Builder.Build_ForImplementer("arb-fix", "imp-2", @"C:\repos\arb", null, null, pidFile, null);
    ...
    public void Reviewer_TheWindowItSpawns_IsTheWindowTheTerminatorCloses()
    {
        ...
        var command = SpawnCommand_Builder.Build_ForReviewer("arb-fix", "rev-1", @"C:\repos\arb", null, null, pidFile, null);
