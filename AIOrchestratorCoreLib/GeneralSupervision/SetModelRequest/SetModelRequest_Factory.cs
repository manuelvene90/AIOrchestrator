...
public static class SetModelRequest_Factory
{
    ...
    public static ISetModelRequest Create(string orchId, string role, string model, string sourceFilePath)
    {
        ...
        return new SetModelRequestModel(orchId, normalizedRole, model.Trim(), sourceFilePath);
    }
}
