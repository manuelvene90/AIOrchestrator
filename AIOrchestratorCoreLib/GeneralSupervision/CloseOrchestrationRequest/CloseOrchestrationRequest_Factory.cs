...
{
    public static ICloseOrchestrationRequest Create(string orchId, string reason, string requester, string sourceFilePath)
    {
        ...
        return new CloseOrchestrationRequestModel(orchId, reason, requester, sourceFilePath);
    }
}
