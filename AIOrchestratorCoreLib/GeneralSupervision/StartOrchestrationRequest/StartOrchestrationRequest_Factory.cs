...
{
    public static IStartOrchestrationRequest Create(string repoQuery, string sourceFilePath)
    {
        ...
        return new StartOrchestrationRequestModel(repoQuery, sourceFilePath);
    }
}
