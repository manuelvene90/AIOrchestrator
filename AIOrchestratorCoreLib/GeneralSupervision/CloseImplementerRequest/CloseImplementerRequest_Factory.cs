...
{
    public static ICloseImplementerRequest Create(string orchId, string memberId, string reason, string sourceFilePath)
    {
        ...
        return new CloseImplementerRequestModel(orchId, memberId, reason, sourceFilePath);
    }
}
