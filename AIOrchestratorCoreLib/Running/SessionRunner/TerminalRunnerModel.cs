...
/// supervisor and the solo are given a resume id at all; the reviewer and the implementer take the
/// effort and nothing else, because they re-enter through their role command by design.
/// </para>
/// </summary>
