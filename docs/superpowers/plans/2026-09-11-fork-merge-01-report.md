...
~~`Bridge/QuestionHold_Policy.cs`~~ **WIRED (Task 6, 55c5008 — read per ENTRY inside `Mirror_Append_Async`, tri-state `Held` honoured by the tick loop)** · `Formatting/ModelReading_Formatter.cs` (Task 8) ·
